...
if (isset($_POST['login'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            $headers = "From: no-reply@speech2sql.com";

            mail($email, $subject, $message, $headers);

           echo "<script> alert('OTP has been sent to your email! Your OTP is: $otp'); window.location.href = 'verify_otp.php'; </script>";
            exit;
        ...
        <div class="card-body p-5 text-black">
          ...
          <form action="loginn.php" method="POST">
            ...
            <p class="mt-3">Forgot password? 
              <a href="passchange.php" style="color: #0d6efd; text-decoration: none;">Change password</a>
            </p>
          </form>
