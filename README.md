...
> ⚠️ **FFmpeg is required for audio transcription**
>
...
├─ trainedmodel/          # Fine-tuned LLM + tokenizer
├─ rag_store/             # FAISS index + schemas (auto-generated)
├─ static/                # Frontend static files
├─ templates/             # HTML templates
├─ history.db             # SQLite for query history
├─ requirements.txt
└─ README.md
```
